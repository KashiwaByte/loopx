...
| Company Control Loop | 将公司工作路由给 AI、人类决策、人类执行、监控或 blocker，并把证据汇入下一轮规划。 | `loopx company-control-loop`、[Company Control Loop](docs/reference/company-control-loop.md) |
